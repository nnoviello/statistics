...
public class ProblemBuilderTest
{
	...
	public void verifyBuildsProblem() throws Exception
	{
		...
		System.out.println(problem.getStepSequence(13).printInterfaceUpdates()); 
		System.out.println(problem.getStepSequence(13).toString()); 
//		System.out.println(problem.getStepSequence(13).getLittleStepSequences().get(0).toString()); 
//		System.out.println(problem.getStepSequence(13).getLittleStepSequences().get(1).toString()); 
//		System.out.println(problem.getStepSequence(13).getLittleStepSequences().get(0).printInterfaceUpdates()); 
//		System.out.println(problem.getStepSequence(13).getLittleStepSequences().get(1).printInterfaceUpdates()); 
		System.out.println(problem.getStepSequence(14).printInterfaceUpdates()); 
		System.out.println(problem.getStepSequence(14).toString()); 
//		System.out.println(problem.getStepSequence(14).getLittleStepSequences().get(0).toString()); 
//		System.out.println(problem.getStepSequence(14).getLittleStepSequences().get(1).toString()); 
//		System.out.println(problem.getStepSequence(14).getLittleStepSequences().get(0).printInterfaceUpdates()); 
//		System.out.println(problem.getStepSequence(14).getLittleStepSequences().get(1).printInterfaceUpdates()); 
